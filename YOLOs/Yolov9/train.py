...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='yolov9-m.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-m.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'P:/Graduation_Design/Dataset/JHU_CROWD/jhu_crowd_v2.0/jhu_crowd_v2.0/data.yaml', help='dataset.yaml path')
